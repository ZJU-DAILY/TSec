...
def train_ed(dataset_name: str):
    ...
    model = KNeighborsTimeSeriesClassifier(distance="dtw", n_jobs=-1)
...
if __name__ == '__main__':
    ...
    for dataset in dataset_list:
        ...
        with open(f'/home/zju/CFdtan/baselines/AeonTest/DTW/performance/{dataset}.json', 'w') as f:
    ...
    # record_df.to_csv('/home/zju/CFdtan/baselines/AeonTest/DTW/performance/dtw_single_final_record.csv', index=False)
